...
const products = [
  {
    ...
    media: [
      ...
      { type: "image", src: "assets/products/octopus-closeup.jpg", widths: [400, 600], alt: "התמנון שעושה סדר בוורוד מוחזק ביד", fill: true },
      { type: "image", src: "assets/products/octopus-shelf.jpg", widths: [400], alt: "התמנון שעושה סדר בצהוב עם עפרונות על שולחן", fill: true },
