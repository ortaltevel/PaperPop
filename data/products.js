...
const products = [
  {
    ...
    media: [
      ...
      { type: "image", src: "assets/products/octopus-pair.jpg", alt: "התמנון שעושה סדר בתכלת ובוורוד עם עפרונות", fill: true },
      { type: "image", src: "assets/products/octopus-lifestyle.jpg", alt: "התמנון שעושה סדר בתכלת על שולחן עבודה", fill: true },
      { type: "image", src: "assets/products/octopus-closeup.jpg", widths: [400, 600], alt: "נערה מחזיקה את התמנון שעושה סדר בוורוד", fill: true },
      { type: "image", src: "assets/products/octopus-shelf.jpg", alt: "נער ליד התמנון שעושה סדר בצהוב על שולחן", fill: true },
      { type: "image", src: "assets/products/octopus-scene.jpg", alt: "התמנון שעושה סדר בתכלת לצד הברווז השובב", fill: true },
    ],
  },
  {
    id: "duck",
    ...
    media: [
      ...
      { type: "image", src: "assets/products/duck-closeup.jpg", alt: "הברווז השובב על מדף בחדר עבודה", fill: true },
      { type: "image", src: "assets/products/duck-stand.jpg", widths: [400, 600], alt: "הברווז השובב מוצג על קובייה שחורה", fill: true },
      { type: "image", src: "assets/products/duck-desk.jpg", alt: "הברווז השובב מונח על מדף בבית", fill: true },
      { type: "image", src: "assets/products/duck-scene.jpg", alt: "הברווז השובב מוצג בסלון על מזנון", fill: true },
    ],
  },
  {
    id: "heart",
  ...
  },
  {
    ...
    card: {
      src: "assets/products/fox-tight.png",
